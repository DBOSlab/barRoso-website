...
# --- Configuration ----------------------------------------------------------
pkg_name <- "barRoso"                                   # package name
pkg_dir  <- "/Users/domingoscardoso/Library/Mobile Documents/com~apple~CloudDocs/Publications_Bioinformatics/barRoso_package_and_website/barRoso"
